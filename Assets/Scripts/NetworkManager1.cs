...
public class NetworkManager1 : MonoBehaviourPunCallbacks
{
    ...
    private void Start()
    {
        ...
        if (PhotonNetwork.IsMasterClient)//분필
        {
            ...
            PhotonNetwork.InstantiateSceneObject("Pen", new Vector3(Random.Range(-8, 7), Random.Range(2, 4), 0), Quaternion.identity);
            PhotonNetwork.InstantiateSceneObject("Sharp", new Vector3(Random.Range(-8, 7), Random.Range(2, 4), 0), Quaternion.identity);
        }
    }
